            ...
            <div class="card-body" id="send_new">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="frase_ativacao" id="frase_ativacao" class="form-control" rows="8"></textarea>
                    </div>

                    <div class="col-12">
                        <label for="explicacao_honorarios" class="form-label">Explicação dos honorários</label>
                        <textarea name="explicacao_honorarios" id="explicacao_honorarios" class="form-control" rows="8"></textarea>
                    </div>
...
-->
                    ...
                    <div class="col-12">
                        <label for="contrato_formatado" class="form-label">Contrato formatado (.docx)</label>
                        <input name="contrato_formatado" id="contrato_formatado" type="file" class="form-control">
                    </div>

                    <!-- Documentos solicitados -->
                    <div class="col-12">
                        <label for="documentos_solicitados" class="form-label">Documentos que a Júlia deve solicitar ao cliente</label>
                        <textarea name="documentos_solicitados" id="documentos_solicitados" class="form-control" rows="8"></textarea>
                    </div>
                        ...
                        <tbody>
                            ...
                            <tr id="categoria-{{$categoria->id}}">
                                ...
                                <td>
                                    <div>
                                        <!-- Botão de Editar -->
                                        <a href="/produto-cliente/{{$categoria->id}}" class="btn btn-link btn-editar" data-id="{{ $categoria->id }}" style="width:30px">
            ...
            <div class="card-body" id="send_new">
                <div class="row g-3">
                    <div class="col-12 col-lg-6">
                        ...
                        <input placeholder="Av. Farias Lima, 1512 - Sala 15b, São Paulo/SP" type="text" name="endereco" id="endereco" class="form-control" value="{{ old('endereco', $personalizacao->endereco ?? '') }}">
                    </div>
            ...
            <div class="card-body" id="send_new">
                <div class="row g-3">
                    <div class="col-12 col-lg-12">
                        ...
                        <textarea name="boasvindas_mensagem" id="boasvindas_mensagem" class="form-control" rows="8">{{ old('boasvindas_mensagem', $personalizacao->boasvindas_mensagem ?? '') }}</textarea>
                    </div>
                    ...
                    <div class="col-12 col-lg-12">
                        ...
                        @if($personalizacao && $personalizacao->boasvindas_video)
                        <br />
                        <a href="{{$personalizacao->boasvindas_video}}" target="_blank">{{$personalizacao->boasvindas_video}}</a>
                        @endif
                    </div>
                    ...
                    <div class="col-12 col-lg-12">
                        ...
                        @if($personalizacao && $personalizacao->resumo_video)
                        <br />
                        <a href="{{$personalizacao->resumo_video}}" target="_blank">{{$personalizacao->resumo_video}}</a>
                        @endif
            ...
            <div class="card-body" id="send_new">
                <div class="row g-3">
                    ...
                    <div class="col-12 col-lg-4">
                        ...
                        @if($personalizacao && $personalizacao->contrato_gerado_video)
                        <br />
                        <a href="{{$personalizacao->contrato_gerado_video}}" target="_blank"> {{ Str::limit($personalizacao->contrato_gerado_video,50)}}</a>
                        @endif
                    </div>
                    ...
                    <div class="col-12 col-lg-4">
                        ...
                        @if($personalizacao && $personalizacao->contrato_assinado_video)
                        <br />
                        <a href="{{$personalizacao->contrato_assinado_video}}" target="_blank">{{Str::limit($personalizacao->contrato_assinado_video,50)}}</a>
                        @endif
                    </div>
                </div>
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        confirmSubmit.addEventListener('click', () => {
            ...
            console.log(confirmInput.value.trim());
...
<script>
    ...
    $(document).ready(function() {
        $('.delete-btn').click(function(e) {
            ...
            let url = "{{ route('produto-cliente.delete', ':id') }}".replace(':id', categoriaId);
