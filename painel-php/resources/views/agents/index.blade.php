...
<div class="row">
    ...
    <style>
        ...
        .pagination .page-item {
            margin: 0 5px;
            /* Espaçamento entre os itens de página */
        }

        .pagination .page-link {
            border-radius: 50%;
            /* Tornar os links redondos */
            padding: 10px 15px;
        ...
        /* Ocultar a paginação extra */
        .dataTables_paginate.paging_simple_numbers {
            display: none;
            /* Oculta a paginação extra */
        }
