            ...
            <div class="card-body" id="send_new">
                <div class="row mb-12">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="conteudo" style="width:100%" type="text" class="form-control" rows="4" cols="50"></textarea>
                    </div>
                </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row mb-12" id="criativos-container">
                    ...
                    <div class="col-sm-12 col-md-2 text-justify my-col" style="border-radius: 10px">
                        ...
                        <div class="row mb-12 text-center ">
                            <div class="col-sm-12 col-md-6">
                                <a href="/criativos/{{$criativo->id}}/edit" style="width:100%" class="btn success-btn my-edit" title="Deletar">
                                    <i class="bi bi-pencil-square"></i>
                                </a>
                            </div>
                            <div class="col-sm-12 col-md-6">
                                <button style="width:100%" class="btn success-btn my-delete" data-id="{{ $criativo->id }}" title="Deletar">
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (response.success) {
                                Swal.fire("Deletado!", "Criativo deletado com sucesso!", "success")
