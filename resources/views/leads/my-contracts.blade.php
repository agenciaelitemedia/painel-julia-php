            ...
            <table class="table align-middle table-striped" id="dataContracts">
                <thead class="table">
                    <tr>
                        ...
                        <th width="230" class="text-center">Telefone</th>
                ...
                <tbody>
                    ...
                    <tr data-id="{{ $contract }}">
                        ...
                        <td class="text-center">
                            ...
                            <button class="btn btn-link" style="margin-right: 0px; padding-right: 0px;" onclick="copyToClipboard('{{ $contract->whatsapp_number }}')" title="Copiar número">
                                <i class="bi bi-clipboard"></i>
                            </button>
                            <a target="_blank" href="https://wa.me/{{$contract->whatsapp_number}}" class="btn btn-link" style="margin-left: 0px; padding-left: 0px;" title="Ir para o whatsapp">
