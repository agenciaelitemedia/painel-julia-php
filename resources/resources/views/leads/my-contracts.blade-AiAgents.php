                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="100" class="text-center">
                                ...
                                <a href="javascript:void(0);" onclick="callWavoip('{{ '5534988860163' }}', 'Mario')" class="btn btn-link" title="Chamar no Wavoip">
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#dataContracts').DataTable({
                ...
                searching: false,
                ordering: true,
                order: [[0, 'desc']], // Order by first column (Data do Contrato) descending
                info: true,
                paging: true,
                lengthChange: false,
                language: {
        ...
        function callWavoip(phone, name) {
            const token = 'a6057143-f443-4c11-a3ee-c1871d9fbbb7'; // Substitua pelo token real
            const url = `https://app.wavoip.com/call?phone=${phone}&name=${encodeURIComponent(name)}&token=${token}&close_after_call=true&available_after_call=false`;
            window.open(url, "wavoip", "menubar=1,resizable=1,width=500,height=500");
        }
    </script>
