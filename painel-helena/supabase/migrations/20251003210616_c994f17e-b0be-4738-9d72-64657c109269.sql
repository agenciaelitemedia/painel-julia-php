...
-- CONTACTS: Isolamento por client_id
...
-- MESSAGES: Isolamento por client_id
...
-- WHATSAPP_INSTANCES: Isolamento por client_id
...
-- SETTINGS: Isolamento por client_id
...
-- CRM_ACTIVITIES: Isolamento por client_id
...
COMMENT ON TABLE contacts IS 'Multi-tenant: Contatos isolados por client_id';
COMMENT ON TABLE messages IS 'Multi-tenant: Mensagens isoladas por client_id';
COMMENT ON TABLE whatsapp_instances IS 'Multi-tenant: Instâncias WhatsApp isoladas por client_id';
COMMENT ON TABLE settings IS 'Multi-tenant: Configurações isoladas por client_id';